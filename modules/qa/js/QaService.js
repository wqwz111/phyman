...
.factory('QaService', ['$http', '$q', '$rootScope', 'jwtHelper', '$log',
    ...
    return {
        getList:function(id) {
            ...
            $http.post('/PHYMAN/index.php/Home/Qa/getList', {
        ...
        newQ:function(qa){
          	 var deferred = $q.defer();
               $http.post('/PHYMAN/index.php/Home/Qa/newQuestion', {
                   username:201522040840,// $rootScope.username,
        ...
        newA: function(qa,id) {
            var deferred = $q.defer();
            $http.post('/PHYMAN/index.php/Home/Qa/newAnswer',{
            	username: 201522040840,//$rootScope.username,
            	id:id,
                answer: qa.answer
            })
